= griffon-devicons-plugin
:linkattrs:
:project-name: griffon-devicons-plugin
...
link:http://vorillaz.github.io/devicons/[DevIcons, window="_blank"] gives you scalable vector icons.
