...
----
dependencies {
    griffon '{project-group}:griffon-devicons-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-devicons-swing:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-devicons-javafx:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-devicons-swing-groovy:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-devicons-javafx-groovy:{project-version}'
}
----

== Maven

First configure the `griffon-devicons-plugin` BOM in your POM file, by placing the following
